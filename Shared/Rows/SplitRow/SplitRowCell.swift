...
open class SplitRowCell<L: RowType, R: RowType>: Cell<SplitRowValue<L.Cell.Value,R.Cell.Value>>, CellType where L: BaseRow, R: BaseRow{
	...
	open override func cellBecomeFirstResponder(withDirection: Direction) -> Bool {
		...
		if isFirstResponder {
            guard let formviewcontroller = formViewController() as? FormMessagesAppViewController else { return isFirstResponder }
	...
	open override func cellResignFirstResponder() -> Bool{
		...
		if resignedFirstResponder {
            guard let formviewcontroller = formViewController() as? FormMessagesAppViewController else { return resignedFirstResponder }
