...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionIdentifier: String?
    ...
    open var optionCalendarBackgroundColorTodayHighlight = UIColor.gradientColor2
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = UIColor.gradientColor2
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = UIColor.gradientColor2
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    open var optionCalendarUnderlinedBackgroundColor = UIColor.gradientColor2
    ...
    open var optionClockBackgroundColorAMPMHighlight = UIColor.gradientColor2
    ...
    open var optionClockBackgroundColorHourHighlight = UIColor.gradientColor2
    open var optionClockBackgroundColorHourHighlightNeedle = UIColor.gradientColor2
    ...
    open var optionClockBackgroundColorMinuteHighlight = UIColor.gradientColor2
    open var optionClockBackgroundColorMinuteHighlightNeedle = UIColor.gradientColor2
    ...
    open var optionButtonFontColorCancel = UIColor.gradientColor2
    open var optionButtonFontColorDone = UIColor.gradientColor2
    open var optionButtonFontColorCancelHighlight = UIColor.gradientColor2.withAlphaComponent(0.25)
    open var optionButtonFontColorDoneHighlight = UIColor.gradientColor2.withAlphaComponent(0.25)
    ...
    open var optionTopPanelBackgroundColor = UIColor.gradientColor2
    ...
    open var optionSelectorPanelBackgroundColor = UIColor.gradientColor2.withAlphaComponent(0.9)
    ...
    fileprivate var tintColor : UIColor! = UIColor.gradientColor2
...
//        }
      let sb = UIStoryboard(name: "WWCalendarTimeSelector", bundle: nil)
      let vc = sb.instantiateViewController(withIdentifier: "WWCalendarTimeSelector") as! WWCalendarTimeSelector
      return vc
    }
