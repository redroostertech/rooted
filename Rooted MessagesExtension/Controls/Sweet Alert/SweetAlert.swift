...
//        }
  ...
  open func showAlert(on vc:UIViewController, title: String) -> SweetAlert {
    _ =  showAlert(on: vc, title: title, subTitle: nil, style: .none)
        return self
    }
    
    open func showAlert(on vc:UIViewController,  title: String, subTitle: String?, style: AlertStyle) -> SweetAlert {
        _ = showAlert(on: vc, title: title, subTitle: subTitle, style: style, buttonTitle: "OK")
        return self

    }

    open func showAlert(on vc:UIViewController, title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        _ = showAlert(on: vc, title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: UIColor.colorFromRGB(0xAEDEF4))
        userAction = action
        return self
    }
    
    open func showAlert(on vc:UIViewController,  title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        _ = showAlert(on: vc, title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: buttonColor,otherButtonTitle:
            nil)
        userAction = action
        return self
    }

    open func showAlert(on vc:UIViewController,
                        title: String,
                        subTitle: String?,
                        style: AlertStyle,
                        buttonTitle: String,
                        ...
                        action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
      self.showAlert(on: vc, title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: buttonColor,otherButtonTitle:
